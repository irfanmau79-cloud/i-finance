...
<div class="dash-card">
    ...
    <form method="POST" action="{{ $npdEdit ? route('npd.pd.update', $npdEdit) : route('npd.pd.store') }}" id="npd-pd-form" enctype="multipart/form-data" data-start-step="{{ $wizStartStep }}">
        @csrf

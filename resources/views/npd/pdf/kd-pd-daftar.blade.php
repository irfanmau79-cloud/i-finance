...
<body>
  ...
  <table>
    <colgroup>
      <col style="width:3%;"><col style="width:14%;"><col style="width:4%;"><col style="width:2.5%;">
      <col style="width:7%;"><col style="width:8.5%;"><col style="width:2.5%;"><col style="width:7.5%;">
      <col style="width:8.5%;"><col style="width:2.5%;"><col style="width:7.5%;"><col style="width:7.5%;">
    ...
    <thead>
      <tr>
        ...
        <th rowspan="2">JUMLAH YANG<br>DITERIMA<br>(Rp)</th>
        <th rowspan="2">TANDA<br>TANGAN</th>
      </tr>
      <tr>
        <th>JML HARI</th>
        ...
        <th>JUMLAH<br>AKOMODASI<br>(Rp)</th>
        <th>JML HARI</th>
        <th>UANG SAKU<br>DIKLAT (Rp)</th>
        <th>JUMLAH UANG<br>SAKU DIKLAT<br>(Rp)</th>
        <th>TRANSPORT<br>/BBM/TIKET<br>(Rp)</th>
      </tr>
    </thead>
    <tbody>
      {!! $rowsBody !!}

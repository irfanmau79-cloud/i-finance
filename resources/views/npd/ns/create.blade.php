...
<div class="dash-card">
    ...
    <form method="POST" action="{{ $npdEdit ? route('npd.ns.update', $npdEdit) : route('npd.ns.store') }}" id="npd-ns-form" enctype="multipart/form-data" data-start-step="{{ $wizStartStep }}">
        @csrf
...
(function () {
    ...
    function naraRowHtml(idx) {
        return '<div class="pen" data-nara-row>'
            ...
            + '<div class="fg"><label class="fl">Honor (otomatis)</label><input type="text" data-honor readonly value="Rp 0" style="background:var(--surface-2);font-weight:700;"></div>'
            ...
            + '<div class="fg"><label class="fl">Bruto (otomatis)</label><input type="text" data-bruto readonly value="Rp 0" style="background:var(--surface-2);font-weight:700;"></div>'
            ...
            + '<div class="fg"><label class="fl">Diterima / Netto (otomatis)</label><input type="text" data-netto readonly value="Rp 0" style="background:var(--surface-2);font-weight:700;"></div>'

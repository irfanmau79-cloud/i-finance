...
<div class="form-grid2">
    ...
    <div class="fg">
        ...
        <input id="nip" name="nip" value="{{ old('nip', $p->nip ?? '') }}" placeholder="Nomor Induk Pegawai" required>
    </div>
</div>
...
<div class="form-grid2">
    ...
    <div class="fg">
        ...
        <input id="rekening" name="rekening" value="{{ old('rekening', $p->rekening ?? '') }}" placeholder="Opsional">
    </div>
</div>

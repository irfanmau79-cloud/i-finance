...
<style>
  ...
  .gt-field label{font-size:11px;font-weight:700;letter-spacing:.3px;text-transform:uppercase;color:var(--mut,#64748b);margin:0;}
  .gt-field-search{flex:1 1 auto;min-width:120px;}
  .gt-inp{height:40px;border:1.5px solid var(--line,#e2e8f0);border-radius:11px;padding:0 13px;font-size:13.5px;color:var(--navy);background:#fff;outline:none;transition:border-color .15s,box-shadow .15s;font-family:inherit;}
  ...
  .gt-info{flex:0 0 auto;font-size:12.5px;color:var(--mut,#64748b);margin:2px 2px 10px;min-height:16px;}
  .gt-tabel-box{flex:1;min-height:0;overflow:auto;border:1.5px solid var(--line,#e2e8f0);border-radius:14px;background:#fff;box-shadow:0 1px 3px rgba(15,39,64,.05);}
  .gt-tabel-wrap{min-width:820px;}
  .gt-empty{padding:34px 24px;text-align:center;color:var(--mut,#64748b);font-size:13.5px;}
  ...
  .gt-table tbody td{padding:8px 11px;font-size:12.5px;border-bottom:1px solid #eef2f6;border-right:1px solid #f1f5f9;vertical-align:top;color:#1e293b;}
  .gt-table tbody td:last-child{border-right:none;}
  .gt-table tbody tr:nth-child(even){background:#f9fbfd;}
  ...
  .gt-peg .n{font-weight:700;color:var(--navy);font-size:12.5px;line-height:1.25;}
  .gt-peg .m{font-size:10.5px;color:#64748b;line-height:1.35;margin-top:1px;}
  .gt-strong{font-weight:700;color:var(--navy);}
  .gt-pill{display:inline-block;padding:2px 9px;border-radius:50px;font-size:11.5px;font-weight:700;background:var(--navy-l);color:var(--navy);}
  ...
  .gt-pager button,.gt-pager a{min-width:36px;height:36px;padding:0 12px;border:1.5px solid var(--line,#e2e8f0);background:#fff;border-radius:10px;font-size:13px;font-weight:600;color:var(--navy);cursor:pointer;transition:all .15s;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;font-family:inherit;}
  ...
  .gt-pager .gt-pg-info{font-size:12.5px;color:var(--mut,#64748b);margin:0 4px;}
  ...
  .gtc-inp{height:40px;border:1.5px solid var(--line,#e2e8f0);border-radius:11px;padding:0 13px;font-size:13.5px;color:var(--navy);background:#fff;outline:none;transition:border-color .15s,box-shadow .15s;font-family:inherit;width:100%;box-sizing:border-box;}
  ...
  .gtc-suggest{position:absolute;top:44px;left:0;right:0;background:#fff;border:1.5px solid var(--line,#e2e8f0);border-radius:12px;box-shadow:0 8px 24px rgba(15,39,64,.12);max-height:260px;overflow:auto;z-index:30;}
  .gtc-suggest .it{padding:9px 13px;cursor:pointer;border-bottom:1px solid #f1f5f9;}
  .gtc-suggest .it:last-child{border-bottom:none;}
  .gtc-suggest .it:hover,.gtc-suggest .it.active{background:var(--navy-l);}
  .gtc-suggest .it .n{font-weight:700;color:var(--navy);font-size:13px;}
  .gtc-suggest .it .m{font-size:11px;color:#64748b;}
  ...
  .gtc-chip{display:flex;align-items:center;gap:7px;padding:8px 11px;border:1.5px solid var(--line,#e2e8f0);border-radius:10px;font-size:12.5px;cursor:pointer;user-select:none;transition:all .12s;color:#334155;}
  ...
  .gtc-toggle-line{display:flex;align-items:center;gap:10px;font-size:13.5px;color:var(--navy);font-weight:600;}
  ...
  .gtc-slider{position:absolute;inset:0;background:#cbd5e1;border-radius:50px;transition:.2s;cursor:pointer;}
  .gtc-slider:before{content:"";position:absolute;height:18px;width:18px;left:3px;top:3px;background:#fff;border-radius:50%;transition:.2s;}
  ...
  .gtc-pd-item label{font-size:12px;font-weight:600;color:var(--navy);margin:0;}
  .gtd-del{padding:6px 14px;border:1.5px solid #e05252;background:#fff;color:#c0392b;border-radius:9px;font-size:12.5px;font-weight:600;cursor:pointer;transition:all .15s;}
